...
function displayProducts(data) {
  ...
  data.forEach((element) => {
    ...
    rating.innerText = `Rating: ${element.rating.rate} (${element.rating.count})`;

    cards.append(image, title, price, description, category, rating);
...
document.querySelector("#sorting").addEventListener("change", () => {
  let sortValue = document.querySelector("#sorting").value;
  ...
  if (sortValue === "asc") {
    ...
    array = [...products]; // Reset to original
  }
